...
_lr_productions = [
  ...
  ('statement -> NAME EQUALS expression','statement',3,'p_statement_assign','learningply.py',54),
  ('statement -> expression','statement',1,'p_statement_expr','learningply.py',58),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','learningply.py',62),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','learningply.py',63),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','learningply.py',64),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','learningply.py',65),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','learningply.py',72),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','learningply.py',76),
  ('expression -> NUMBER','expression',1,'p_expression_number','learningply.py',80),
  ('expression -> NAME','expression',1,'p_expression_name','learningply.py',84),
]
