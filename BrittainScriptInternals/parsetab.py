...
_lr_signature = 'ASSIGN COSINE DIVIDE ELSEIF EQUALS FOR FUNC FUNC_CALL IF LPAREN MINUS MULTIPLY NUMBER PI PLUS POWER PRINT RPAREN SINE SQUAREROOT STRING TANGENT WHILEexpression : NUMBERexpression : expression PLUS expressionexpression : expression MINUS expressionexpression : expression DIVIDE expressionexpression : expression MULTIPLY expressionexpression : SQUAREROOT LPAREN expression RPARENexpression : expression POWER expressionexpression : SINE LPAREN expression RPARENexpression : COSINE LPAREN expression RPARENexpression : TANGENT LPAREN expression RPARENexpression : PIexpression : FUNC_CALLexpression : PRINT LPAREN expression RPARENstatement : assignmentstatement : expressionassignment : STRING EQUALS expression'
...
_lr_productions = [
  ...
  ('statement -> assignment','statement',1,'p_statement_assignment','parser.py',111),
  ('statement -> expression','statement',1,'p_statement_expression','parser.py',115),
  ('assignment -> STRING EQUALS expression','assignment',3,'p_assignment','parser.py',119),
]
